              ...
              <div>
                <div className="w-full lg:w-1/1 p-1">
                  <div className="flex flex-col lg:flex-row rounded overflow-hidden h-auto lg:h-32 border shadow shadow-lg">
                    {/* <Image objectFit="contain" layout="fill" className="block h-10 w-full lg:w-10 flex-none bg-cover h-24" src="https://pbs.twimg.com/media/DrM0nIdU0AEhG5b.jpg" /> */}
                    <div className="bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
                      <div className="text-black font-bold text-xl mb-0 leading-tight">Nama minuman</div>
                      <div className="inline-block px-2 py-1 leading-none bg-orange-200 text-orange-800 rounded-full font-semibold uppercase tracking-wide text-xs">kategori</div>
                      <p className="text-green-darker text-base">20.000</p>
                    </div>
                  </div>
                </div>
                <div className="w-full lg:w-1/1 p-1">
