                            ...
                            <div className="flex flex-wrap -mx-4">
                                {
                                    productState.map((el) => (
                                        <div className="w-full sm:w-1/2 md:w-1/2 xl:w-1/4 p-4">
                                            <a onClick={el.stock == 0 ? () => { } : () => AddCart(el)} className="c-card block bg-white shadow-md hover:shadow-xl rounded-lg overflow-hidden">
                                                ...
                                                <div className="p-4">
                                                    ...
                                                    <div className="mt-3 flex items-center">
                                                        <span className="text-sm font-semibold">Rp</span>&nbsp;<span className="font-bold text-xl">{formatCurrency(el.price)}</span>&nbsp;<span className="text-sm font-semibold">,-</span>
                                                    </div>
                                                </div>
